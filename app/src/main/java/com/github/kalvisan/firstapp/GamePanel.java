package com.github.kalvisan.firstapp;
...
public class GamePanel extends SurfaceView implements SurfaceHolder.Callback
{
    ...
    public void surfaceCreated( SurfaceHolder holder )
    {
        ...
        player = new Player( BitmapFactory.decodeResource( getResources(), R.drawable.red_plane ), 88, 73, 3 );
    ...
    public void update()
    {
        if( player.getPlaying() )
        {
            ...
            if( elapsed > 120 )
            {
                smoke.add( new Smokepuff( player.getX(), player.getY() ) );
                smokeStartTime = System.nanoTime();
            }
